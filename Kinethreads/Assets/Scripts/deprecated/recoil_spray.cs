...
public class recoil_spray : MonoBehaviour, IHandGrabUseDelegate
{
    ...
    {
        StartStamping();
        Pose originalPose = new Pose(_nozzle.position, _nozzle.rotation);
    ...
    private void StartStamping()
    {
        ...
        scomms.sendMessage(UnityEngine.Random.Range(0.4f, 0.8f));
    }
